...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php _e( 'Füllen Sie bitte die untenstehenden Felder vollständig aus. Nach erfolgreicher Registrierung wird Ihr Account von einem Mitarbeiter geprüft und für die Community freigeschaltet. Sie erhalten eine Mail zur Bestätigung.', 'buddypress' ); ?></p>
