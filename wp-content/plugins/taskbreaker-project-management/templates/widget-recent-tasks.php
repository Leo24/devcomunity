...
<?php } else { ?>
	...
	<div class="task-breaker-widget-no-task-assigned">
		...
		<?php if ( is_user_logged_in() ) { ?>
			<?php esc_html_e( 'Sie haben keine neue Aufgabe. Haben sie noch einen schönen Tag!', 'task_breaker' ); ?>
		<?php } else { ?>
			<?php esc_html_e( 'Bitte loggen sie sich ein um ihre Aufgaben einzusehen', 'task_breaker' ); ?>
		<?php } ?>
